...
const SECTIONS = [
  {
    title: '💾 本地优先（无需登录）',
    items: [
      '本工具无账号、无服务器：小说、章节、大纲、聊天与 API Key 全部存在本机',
      '刷新页面或重新打开 App，会自动读取本地数据并恢复上次选中的章节',
      '清除浏览器站点数据 / 卸载 App 会丢失内容，请定期导出 TXT 备份',
    ],
  },
  {
    title: '📚 基本操作',
    items: [
      '左侧：管理小说与章节，点击章节即可编辑',
      '中间：写作区，含章节标题、正文、大纲；可直接改「当前小说」书名',
      '右侧：AI 写作助手（默认折叠，点 🤖 展开）',
      '顶部 ◀ ▶ 或左右滑动可收起/展开侧栏；手机可从屏幕左右边缘滑入唤出',
      '左侧「改名」可修改当前小说书名',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'API Key 仅保存在本地；调用 AI 时才会联网请求你配置的接口',
    ],
  },
  {
    title: '📤 导出与其他',
